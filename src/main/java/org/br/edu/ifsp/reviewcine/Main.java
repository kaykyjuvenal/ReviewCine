...
public class Main {
        ...
        private final String ENDERECO_SERIE = "https://api.themoviedb.org/3/discover/tv?" + API_KEY;
        private final String ENDERECO_FILME = "https://api.themoviedb.org/3/discover/movie?"+ API_KEY;
